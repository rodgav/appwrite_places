...
import 'package:appwrite_places/presentation/resources/font_manager.dart';
import 'package:appwrite_places/presentation/resources/strings_manager.dart';
import 'package:appwrite_places/presentation/resources/styles_manager.dart';
...
class StateRenderer extends StatelessWidget {
  ...
  Widget _getBackButton(String buttonTitle, BuildContext context) {
    return SizedBox(width: AppSize.s200,
      child: Padding(
        padding: const EdgeInsets.all(AppPadding.p18),
